...
const Register = ({kullanici,setKullanici,sifre,setSifre}) => {
  return (
      ...
      <div className="flex bg-blue-950 h-full">
        <div className="w-1/2 mt-20  ">
          ...
          <div className ='  text-center '>
            ...
            <h1 className=' text-5xl text-white ' >Kayıt Ol </h1>
          ...
          <div className="mt-8 px-8 items-center ">
            ...
            <div className="   flex-col text-center">            
              <button className=" rounded-lg mt-4 bg-yellow-500 text-blue-900 border-2 w-2/3 m-auto p-3 text-xl" type="submit"> Kayıt Ol</button>
              <button className=" rounded-lg mt-4 bg-yellow-500 text-blue-900 border-2 w-2/3 m-auto p-3 text-xl "><Link to="/">Giriş Ekranına Dön </Link> </button>
          </div>
